    ...
    <nav class="navbar navbar-inverse" style="padding-top: 5px;font-size: 16px;">
        ...
        <div class="col justify-content-center align-items-center text-center">
          <div class="text-white">
            <h1 class="mb-3" style="margin-top:15%; font-weight: bolder;">Welcome ${cusName}</h1><br>
            <h4 class="mb-4" style="font-weight: bold;">${msg}</h4>
		...
		<tbody>
			...
			<tr>	
				...
				<td>${a.sellerId}</td>
				<td>${a.price}</td>
				<td><a href="add/${a.productId}/${a.sellerId}"><button>buy</button></a><br><br>
